...
public final class Reference {
    ...
    public static final String CLIENT_PROXY_CLASS = "net.re_renderreality.permissions.proxy.ClientProxy";
	...
	private Reference(FMLPreInitializationEvent event) {
		this.MOD_DIR = new File(event.getModConfigurationDirectory(), "Permissions");
